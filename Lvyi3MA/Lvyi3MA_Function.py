...
def calResultByPeriod():
    ...
    #3.设文件和文件夹状态
    filedir='D:\\002 MakeLive\myquant\HopeWin\Results\HopeMacdMaWin SHFE RB 3600\DynamicStopLoss-18.0\ForwardOprAnalyze' #文件所在文件夹
    oprfilename = 'HopeMacdMaWin SHFE.RB3600_Rank6_win4_oprResult.csv' #买卖操作文件名
    dailyResultFileName = 'HopeMacdMaWin SHFE.RB3600_Rank6_win4_oprdailyResult.csv' #日结果文件名
    newFileName = 'HopeMacdMaWin SHFE.RB3600_Rank6_win4 result_by_Period_M.csv' #要生成的新文件名
    os.chdir(filedir)
